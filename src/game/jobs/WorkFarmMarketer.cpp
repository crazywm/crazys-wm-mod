...
// `J` Job Farm - Staff
bool WorkFarmMarketer(sGirl& girl, bool Day0Night1, cRng& rng)
{
...
#pragma region    //    Create Items                //
    ...
    double jobperformance = girl.job_performance(JOB_MARKETER, false);
...
double JP_FarmMarketer(const sGirl& girl, bool estimate)// not used
{
