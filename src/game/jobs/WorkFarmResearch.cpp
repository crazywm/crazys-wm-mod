...
bool WorkFarmResearch(sGirl& girl, bool Day0Night1, cRng& rng)
{
...
#pragma region //    Job setup                //
    ...
    ss << "${name} worked as a reseacher on the farm.";
...
double JP_FarmResearch(const sGirl& girl, bool estimate)// not used
{
