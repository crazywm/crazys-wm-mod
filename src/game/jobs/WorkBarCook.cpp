...
// `J` Job Brothel - Bar
bool WorkBarCook(sGirl& girl, bool Day0Night1, cRng& rng)
{
...
#pragma region //    Job setup                //
    ...
    if (girl.has_active_trait("Homeless") && rng.percent(15))
    {
...
double JP_BarCook(const sGirl& girl, bool estimate)// not used
{
