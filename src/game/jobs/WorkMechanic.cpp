...
// `J` Job Clinic - Staff
bool WorkMechanic(sGirl& girl, bool Day0Night1, cRng& rng)
{
...
#pragma region //    Job Performance            //
    ...
    if (girl.has_active_trait("Construct") && rng.percent(15))
    {
        wages += 15;
        ss << " Seeing a kindred spirit, the mechanical patient left her a great tip.\n";
    }
    if (girl.has_active_trait("Half-Construct") && rng.percent(15))
    {
        wages += 15;
        ss << " Seeing a kindred spirit, the mechanical patient left her a great tip.\n";
    }
...
double JP_Mechanic(const sGirl& girl, bool estimate)// not used
{
