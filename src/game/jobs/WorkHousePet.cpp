...
// `J` Job House - General
bool WorkHousePet(sGirl& girl, bool Day0Night1, cRng& rng)
{
...
#pragma region //    Job setup                //
    ...
    if (train >= 50)            // they refuse to train
    {
        ...
        if (girl.get_training(TRAINING_PUPPY) >= 50)
        {
            if (roll_b >= 66)
            {
                if (dispmod >= 0)
                    {
                        //ss << "\nNice.";
                        ss << "Good puppies eat their dog food and only beg for table scraps sparingly. ${name} became bad tempered and flipped her bowls over, making a mess of the kitchen and herself. You were not amused, nor was the cleaning girl.\n";
                        /**/
                        ss << "It's difficult to stay upset at such a cute little animal for long, so other than a couple swats on ${name}'s upturned ass and letting " << cleanername << " rub her face in it";
                        ...
                        /**/
                        ss << "By the end of the first day, ${name} was clearly having a great deal of effort keeping herself under control as hunger rumbled through her stomach making her tits quiver.";
                        ...
                        ss << " How dare she? That was ${name}'s job! But still ${name} refused.\n";
                        /**/
                        ss << "By dinner time the next night, the seasoned kabobs of meat and veggies were too appetizing to resist, and ${name} crawled under the table, placing her cheek against your manhood, tits quivering as hunger rocked her stomach. ${name} made little whining noises when you smiled down at her,";
                        ...
                        ss << " she licked the dust from the bowl as her stomach growled, albeit less insistently.\"Good girl, ${name}.\" ${name}'s eyes snapped up, humiliated, to " << headname << " as she clipped a leash to her collar.";
                        ...
                        ss << " I think you can sleep at the foot of my bed instead of in your kennel tonight.\" ${name} crawled after " << headname << " obediently.";
                        training += 2;
                        ob += 2;
                    }
                else
                    {
                        ...
                        ss << " " << headname << " grabbed ${name} by the hair, smushing her face into the mess, ignoring her tears.";
                        ss << " \"Your master is displeased, bitch!\" she hissed in her ear. \"We WILL teach you to be a good girl!\"";
                        ss << " " << headname << " scooped bits of the dirty, soggy dog food from the floor and began forcing it into ${name}'s mouth, occasionally rubbing it on her face and giving her cheeks vicious slaps.\n";
                        /**/
                        ss << "${name} was taken by the hair and dragged to the dungeon where she was turned over to Torturer. \"Well well, we've got a naughty puppy don't we?\" Torturer's voice was sweet and comforting, but her eyes were cruel.";
                        ss << " Tying ${name}'s hair into a braid, she tied the braid to a hook and pulled her off the ground. ${name} screamed through her ring gag but her pleas were ignored and her plight just beginning.";
                        ss << " Torturer really pulled out all the stops, first feeding her a mix of animal cum and not-quite ground up bugs, then taking a stinging whip to her body. ${name} sobbed through the gag more when";
                        ...
                        ss << " Torturer patted ${name}'s cheek with a smile to get her attention, while rubbing ${name}'s face against the bulge of the largest member.";
                        ...
                        /**/
                        ss << "You didn't see your pet for two days, but when she arrived for breakfast she was much changed, at least for now. ${name} ate her small cup of foul kibble without complaint, and then crawled over to you, lapping at your shoes in thanks.";
                        ...
                        ss << " she squeals as you hold her down. As your dick begins to soften you loosen your hold, stroking her hair as she licks you clean. \"Good girl, ${name}.\"";
                        ss << " You pat her cheek with a slight smile and ${name} flushes in embarassment. " << headname << " clips a leash to ${name}'s collar and leads her away with a smile.";
                        training += 4;
                        ob += 4;
                    }
            }
            ...
            {
                ss << "While getting her daily bath from " << cleanername << ", ${name} made a huuuuuuge mess " << cleanername << " was not pleased,";
                ss << " but realizes the bitch is still just an untrained, rebellious dog. After a few vicious swats on ${name}'s upturned";
                ...
                ss << " After getting " << headname << "'s permission, " << cleanername << " took ${name} with her all day during her jobs. ${name} was forced to clean toilets,";
                ...
                /**/
                ss << "By the end of the day, ${name} was quite contrite as " << cleanername << " lead her crawling back to the bathroom. \"I'm sorry, but you'll learn, one way or another, ${name}.\"";
                ss << " It didn't take much coaxing to get ${name} into the frothy tub, and surprisingly " << cleanername << " joined her.";
                ss << " Both girls were clean soon, but " << cleanername << " decided they were going to stay and relax a bit longer.";
                ss << " \"Don't you think you owe me an apology?\" she asked, stroking the suds from ${name}'s hair. Whether she did or";
                ss << " not, ${name} leaned in, ignoring the soap getting in her mouth, and began to gently tongue " << cleanername << "'s clit. She gasped as your pet suckled her,";
                ss << " and then grabbed the back of her head as ${name} began to fuck her with her tongue, occasionally pushing and nibbling at her clit at the same time using her upper lip.";
            ...
            else
            {
                ...
                if (dispmod >= 0)//GOOD
                {
                    ss << "You initial reaction is a swift spanking, and you oblige with a number of well-aimed swats at ${name}'s ass with the offended shoe.";
                    ...
                    ss << " She leads ${name} away while you and the cobbler talk idly of the old days and get your new shoes sized.\n";
                    /**/
                ...
                {
                    ss << "\"Bad dog!\" you should, wailing on your pet's upturned ass, your foot in the middle of her back, forcing her down. ${name}";
                    ...
                    ss << " In a quick motion, you force a dildo that is entirely too large down ${name}'s throat and pull a tight cloth hood over her face.";
                    ...
                    ss << " keeping her warm as one of their own. On the other, ${name} received rather savage fuckings from all of them on a regular basis.";
                    ...
                    /**/
                    ss << "Finally you go to get her at the end of the week. ${name} is a complete wreck, shivering and skittish. You pull get her attention with a quick slap to the face, and a few more to the tits and cunt for good measure.";
                    ...
                    ss << " Show me what a good girl you can be.\" ${name} was dehydrated enough that tears didn't come,";
        ...
        else//low skill
        {
            if (roll_b >= 50)
            {
                ss << "\"NO! What the fuck is wrong with you!\" ${name} screamed up at you. \"I'm NOT your fucking dog! Let me up or you'll be sorry!\" ";
                ss << "\"You can't treat people like this!\" You sigh as ${name} screams and raves. New pets often act out their aggression. It's not entirely their fault, ";
                ...
                if (dispmod >= 0)/*NICE DISP*/
                    {
                        ss << "\"Bad girl, ${name}. Bitches don't use human words!\" You admonish her with a slight slap to the face, followed by soothing petting. ${name} was having none of it. \"Fuck you, asshole!\" You give her a slighlty heavier slap, you face turning stern.";
                        ss << " \"I just told you, if you want to talk, you need to do it like the bitch you are.";
                        ss << " Since you're not ready to obey yet, I'll help you learn.\" ${name}'s mouth flew open to begin again but you shove a large, rubber bone in her mouth, causing her to gag and choke.";
                        ...
                        ss << " As the collar clicked in place, you put your hand gently under ${name}'s mouth, holding the toy in.\n";
                        /**/
                        ss << "\n\"Now then, you've earned yourself a week of quiet time, girl.\" ${name} looks at you in consternation as you hold the toy in while stroking her hair. \"This collar isn't going to stop you from speaking, but it's going to help teach you not to. Anytime you try speak and it's not using.... proper language, you're going to get a small shock. ";
                        ...
                        ss << "\"I wish you'd instead just decided to be a good girl. No matter, I'm here for you, to help you learn.\" With a final pat of the cheek, you pull the bone from her mouth. Immediately ${name} tries to speak, but whatever she was going to say was lost in her cry and shudder, shocked by the collar. You stand up, looking down at her, smiling sadly. ";
                        ss << "${name} tried once more to say something, and once more was met with a violent shock, bringing tears to her eyes and little sobs. Your pet was in for a long week.\n";
                        /**/
                        ss << "\nWithin the first day, though, " << headname << " remarked on ${name}'s progress. Soon the girl was indeed trying to speak using barks and whines. She didn't like her food, she wanted attention, she wanted to go out. She did make a few attempts at words at first, but quickly was forced to abandon that line of attempt. By the end of the week, she was grudgingly using only puppy language, and literally eating out of " << headname << "'s hand. ";
                        ss << " When it was finally time, you bent down and called ${name} to you, her old collar in hand. She was clearly happy to see it, but before you replaced the new collar, you stroked the girl's chin and petted her hair.";
                        ss << " \"Are you ready to be a good girl, ${name}?\" She gave a small, reluctant yip, obviously trying to wag her tail. When you didn't replace the collar, she began to lick your fingers, nuzzling the hand that clutched her old collar.";
                        ss << " \"Are you sure? Maybe you need another week?\" ${name} let out a low, feminine howl, and began to lick and kiss her old collar. \"Just checking, girl.\"";
                        ss << " You laugh and unlock the old and new collars, and ${name} quietly places her neck in the band, shuddering a little as it clipped shut. \"Good girl.\" ";
                ...
                else if (dispmod < 0)/*BAD DISP*/
                    {
                        ...
                        ss << " You don't even bother with the leash, you just yank ${name}'s hair as she struggles to keep up on all fours. In your anger it took no time at all to make it to the dungeon at your brothel.";
                        ...
                        /**/
                        ss << "${name} blubbered as you locked her on all fours in the middle of the room near the entrance. \"We'll fucking teach YOU what language is acceptable!\" She began to scream as you criss-crossed her back and her ass,";
                        ...
                        ss << " \"WHAT DID I JUST BEAT YOU FOR?\" It began again. Another hour and you tried again. \"Well bitch?\" It took a few tries, since ${name}'s mouth was completely dry, but she managed a barely adequate, \"Woof...\"\n";
                        /**/
                        ss << "You left your pet there in the dungeon while you attended to other business. " << torturername << " sent a girl along with a bucket of water, and the girl was gently, generously letting ${name} take a few swallows before she began to clean away the traces of her tears and her beating.";
                        ss << " When she was done, the girl put the bitch's head in her lap and petted her,whispering sweetly to her.";
                        ss << " \"Tha- thank you.\" ${name} said haltingly. The cleaning girl's face turned bright, as she raised her voice.";
                        ss << " \"Mistress? She spoke! The bitch spoke!\" ${name} stared in disbelief at the girl who had just cared for her so tenderly. Soon she was sobbing again as the blows rained down on her.";
                        ss << " When " << torturername << " was done, she pulled the girl's sagging head up by her hair. \"What do you say now, bitch?\" \"Woof.\" \"What was that?\" \"Woof!\" ${name} croaked out. \"Good girl.\"";
                        training += 3;
                        ob += 3;
                    }
            }
    ...
    else /*She did the training*/
    {
        ...
        if (girl.get_training(TRAINING_PUPPY) >= 70)
            {
                if (girl.m_WeeksPreg >= 38 && brothel->num_girls_on_job(JOB_HEADGIRL, false) >= 1)
                {
                    ss << headname << " clips a leash to ${name}'s collar. She is happy with her leash being held and content that she's a pet.\n";
                    /**/
                    ss << "${name} was very, very pregnant. " << headname << " had to isolate ${name} from the other puppies, animals, guards, just about everyone really.";
                    ss << " The rough play and enthusiastic activities ${name} was used to could possibly injure her puppies, and";
                    ss << " no one wanted that. ${name} spent her days in a kennel that was much larger than she was used to, with a very soft bed. Her pregnancy was";
                    ss << " making keeping her proper puppy posture difficult, but ${name} was well-trained. The veterinarian would stop by every couple days to check on her,";
                    ss << " so ${name} knew it would be any day now, and she was anxious for the pregnancy to be over so she could get back to being a part of the household.\n";
                    /**/
                    ss << "${name} wasn't lonely, of course. Everyone wanted to visit her, and did! Under the watchful eye of " << headname << ", the girls would stop by and sit with her,";
                    ...
                    ss << " every so often, and he would slip ${name} a Bitch Bite when " << headname << " wasn't looking. Most enjoyable were her Master's visits. ${name} saw";
                    ...
                    ss << " from down the hall. Each time she would greet him by licking his shoes and barking like a good girl. ${name} loved how her Master would smile, and even";
                    ...
                    ss << " isolated. ${name} loved that most of all. She missed laying at her Master's feet, missed sucking his dick, missed the feeling of his hands as he pet her.\n";
                    /**/
                    ss << "\"Time for bed girl.\" ${name} gave a pouting whine at " << headname << ". Master must have been busy today and couldn't visit. ${name} whimpered in resignation,";
                    ss << " and respectfully licked " << headname << "'s long legs. " << headname << " smiled and pet her hair, but still said, \"I mean it, bed!\" ${name} crawled";
                    ...
                    ss << " on her bed. " << headname << " closed the door, wished her a good night, and turned off the light. ${name} sighed restlessly and slowly fell asleep.";
                }
                else if (roll_b >= 90 && is_virgin(girl))
                    {
                        if (roll_c >= 85)
                        {
                            if (dispmod >= 0)/*NICE DISP*/
                            {
                                ss << "You clip a leash to ${name}'s collar and she barks happily. She knows she's just your pet bitch, and she's happy to be with her master.\n";
                                /**/
                                ss << "${name} was anxious. When ";
                                if (headonduty)
                                { ss << "" << headname << ""; }
                                ...
                                ss << " like a good little bitch should, with happy barking, pushing her face into your groin. ${name} was disappoint when you just";
                                ss << " gave her a pat on the head and went to your room to read. ${name} followed you, panting, and licked your shoes, pawing at your cock through your pants.\n";
                                /**/
                                ...
                                ss << " You smile and stroke ${name}'s hair.";
                                ss << " \"Who's my good girl? Who's master's good little bitch?\" ${name} barked happily, and licked your fingers. \"Alright girl,";
                                ss << " I suppose you've waited long enough. Present!\" ${name} yelped as her paws tangled beneath her, unable to move fast enough. Soon she had her face and";
                                ...
                                ss << " of her neck. After a couple minutes, ${name} was able to concentrate past the initial pain. How could this feel so good? Unbidden, her cunt tightened";
                                ...
                                ss << " build and rocked her body as you continued to thrust hard into her pussy. ${name} barked happily as you wrapped her hair around your hand and pulled her up on";
                                ...
                                ss << " close your eyes. After a moment you feel ${name}'s tongue running along each surface of your cock and thighs, cleaning you as she had";
                                ss << " been taught. When you finally open your eyes, ${name}'s cheeks are resting between your cock and your thigh, smiling as you pet her hair. \"Good girl.\"";
                                training += 4;
                                ob += 4;
                            ...
                            else
                            {
                                ss << "You clip a leash to ${name}'s collar and she barks happily. She knows she's just your pet bitch, and she's happy to be with her master.\n";
                                /**/
                                ss << "\"Today is the day, my pretty little bitch.\" You give ${name} an evil smile as you yank her leash, causing her to yelp in surprise. ${name} was torn between a base";
                                ...
                                ss << " him off or he whipped her to remind her of her place. As you lead ${name} through the city, her pussy glistened for everyone looking on.\n";
                                /**/
                                ss << "When you finally reached your destination, ${name} was shocked to hear whines and barks, and her own soon joined the chorus as you dragged her into the";
                                ...
                                ss << " handed ${name}'s leash over. \"Yeah, feel free to use her when she's not enjoying her kennelmates. I'll be back in a week.\" ${name}'s eyes grew wide.";
                                ss << " A week in this place? This was where her virginity would be taken? ${name} began to whine loudly and press herself against her uncaring master's";
                                ...
                                ss << " got louder as ${name} was paraded past a line of kennels and dog runs, each with several dogs, most with a cowering girl. Finally the man stopped";
                                ...
                                ss << " \"Here for ${name}?\" He asked shortly, shoving a leash and tape of her first day into your hands.";
                                ss << " \"Out back.\" You know the way, of course, and head back to the kennels. ${name} was occupied, Prince pounding on her back as she moaned and whined.";
                                ss << " You politely wait until Prince is finished, and when he's done, ${name} crawls over to the gate. \"The fuck? I taught you better manners than that,";
                                ss << " bitch.\" You nod towards Prince in disgust, and the girl crawled back, dismayed. ${name} pushed her way under the large dog and gently used";
                                ...
                                ss << " \"Have a good first time, bitch?\" ${name}'s eyes streamed with tears, but she barked an affirmation. She was, after all, just a bitch dog. This is what she was.";
                                training += 4;
                                ob += 4;
                                girl.lose_trait("Virgin");
                        ...
                        else
                        {
                            ss << "You clip a leash to ${name}'s collar and she barks happily. She knows she's just your pet bitch, and she's happy to be with her master.\n";
                            /**/
                            ss << "${name} was in a constant state of confusion, some days. She was coming acclimating to her status as a mere pet, an animal,";
                            ss << " but still having trouble at times with that meant. When she first became a pet, ${name} was";
                            ...
                            ss << " serving her owner for it's own sake, she was forbidden to cum, and slowly weaned off it being a reward. ${name} simply didn't know what to do.";
                            ...
                            /**/
                            ss << "Secretly, ${name} knew the answer to the question she couldn't ask. As she lay on the couch with her head in your lap, a special privilege in and";
                            ...
                            /**/
                            ss << "${name} began to moan softly as you tickled her clit with your fingers, and rub her smooth mound. It was a torment, but a welcome one,";
                            ss << " and in minutes she was occasionally trying to push backwards on your fingers. ${name} desperately";
                            ...
                            ss << " leaving ${name} bucking empty air for a few moments. She whimpered up at you, and you smiled at the tears pooling in the corners of her pleading eyes.";
                            ss << " \"What's wrong girl? What do you want? Do you need something?\" ${name} gave a tiny bark, wagging her ass, and you laugh, \"No, I don't think you're quite ready. Clean your mess.\"";
                            ss << " ${name} whined, but licked her master's sticky fingers, flushing with both humiliation and embarrassment. Things she never would have considered before now";
                ...
                else if (roll_b >= 80 && brothel->num_girls_on_job(JOB_HOUSEPET, false) >= 2)
                    {
                        ss << "You clip a leash to ${name}'s collar and she barks happily. She knows she's just your pet bitch, and she's happy to be with her master.\n";
                        /**/
                        ss << "Bitches were were an odd mix of competitive and collaborative. ${name} and " << puppyname << " were quite happy right now, between your legs,";
                        ss << " sharing a bone. It was interesting, not to mention pleasurable, to watch their interactions,";
                        ss << " so much so that you put down the book you were reading. ${name} and " << puppyname << " seemed to alternately";
                        ...
                        /**/
                        ss << "At times they would even go further than sharing, with " << puppyname << " nuzzling ${name}'s neck, kissing and licking her as";
                        ...
                        /**/
                        ss << "You suddenly erupt, spewing cum from the tip of your cock. " << puppyname << " had been gently licking up your shaft while ${name} had been";
                        ...
                        ss << " but the bitches were just doing what they should. You smile at the happy look in ${name}'s eyes, and turn the page.";
                        training += 2;
                    }
                else if (roll_b >= 60 && g_Game->has_building(BuildingType::STUDIO))
                    {
                        ss << "You clip a leash to ${name}'s collar and she barks happily. She knows she's just your pet bitch, and she's happy to be with her master.";
                            /**/
                            ss << "Just another day at the studio, with ${name} in tow. She was such a delightful pet, all your porn stars and scene crew loved her visits.";
                            ss << " Some of the best scenes Director shot were when ${name}'s leash was handed over and she was led into being an impromptu fluffer,";
                            ss << " or used as a reward for an excellent scene. Today was different, though. Today, ${name} was the star!\n";
                            /**/
                            ss << "${name} yipped nervously as her makeup was done, pressing her body into the side of your leg. Once her makeup and hair were taken care of,";
                            ss << " she watched in anticipation as the stage was set up like a kitchen. Suddenly a much louder, booming bark";
                            ss << " approached. ${name} quivered, pressing against you harder, nuzzling and licking your hand as a large mastiff was brought in,";
                            ...
                            ss << "${name} relaxed a little, but remained pressed against you until you handed her leash off to RandomStageHand.\n";//here CRAZY
                            /**/
                            ...
                            ss << " Still, all went well, and the Director finally yelled \"Cut!\" with both ${name} and the large dog's faces pressed";
                            ss << " into their meal. ";
                ...
                else if (roll_b >= 40 && brothel->num_girls_on_job(JOB_HEADGIRL, false) >= 1)
                    {
                        ss << headname << " clips a leash to ${name}'s collar. She is happy with her leash being held and content that she's a pet.\n";
                            /**/
                            ss << "${name} spent a day with " << headname << ", as she often did when her Master was busy. Pets often became disappointed when their owners were neglectful,";
                            ...
                            /**/
                            ss << "Today ${name} spent most of the day as a mischievous puppy, crawling behind " << headname << ", exploring the nooks and crannies of your house,";
                            ss << " and generally causing playful trouble. " << headname << " was a little exasperated with ${name}'s small antics, but could hardly";
                            ss << " fault her for behaving as the little pet you trained her and intended her to be. ${name} was sure not to completely crawl out of line, though,";
                            ...
                            /**/
                            ss << "${name} cleaned " << headname << "'s shoes lovingly with her tongue, making sure not to miss a speck of dirt. When she was done, she curled up between her legs and";
                            ss << " laid her cheek on " << headname << "'s thigh, watching her longingly as she did her paperwork. " << headname << " occasionally pet her hair,";
                            ss << " and ${name}'s tongue would hang out of her mouth in a cute pant, whining. \"Later,\" " << headname << " would say with a smile. ${name} would not accept THAT, but";
                            ...
                            ss << " her nose. It took nearly half an hour before she was nosing " << headname << "'s clit through her panties. ${name} would occasionally";
                            ...
                            ss << " did not say anything, ${name} couldn't take it any longer, and pressed her face into the lovely mound, licking and kissing through the fabric,";
                            ss << " trying to push it out of the way with her nose. " << headname << " finally gave up on her paperwork and leaned back in her chair,";
                            ss << " enjoying the attention of the Master's little pet. After an hour and several orgasms had passed, " << headname << " finally gripped ${name}'s hair and";
                            ss << " pulled her away. \"Good girl, now let me work.\" Her voice was kind but firm, and ${name} knew she was done for the time being.";
                ...
                else if (roll_b >= 20)
                    {
                        ss << "You clip a leash to ${name}'s collar and she barks happily. She knows she's just your pet bitch, and she's happy to be with her master.\n";
                        /**/
                        ss << "Many pet owners act neglectfully of their pets, but not you! ${name} was happy when you led her crawling through the city";
                        ss << " to your brothel, excited to keep you company while you worked. Upon arrival, however, you hand off";
                        ss << " ${name}'s leash to a member of a gang, who leads the confused girl fearfully into the dungeon, unsure of what to expect. ${name} flinched";
                        ...
                        ss << " on their backs. ${name} looked up at the gang member and yipped questioningly, nuzzling his thigh like a good puppy.\n";
                        /**/
                        ss << "�Often your Master gets girls that are virgins,� he explained, stroking ${name}'s hair, �And this is part of their....";
                        ...
                        ss << " That's your job today.� Not quite gently, the man grabbed her hair and pushed ${name}'s face into the first girl's cunt. ${name} began to lick";
                        ...
                        ss << " nipples were hard as could be and she was on the cusp, the man tugged ${name} away, leaving the teen thrashing, unfulfilled.\n";
                        /**/
                        ss << "The process was repeated over the course of a couple hours, the gang member occasionally giving ${name}'s wagging ass little slaps to motivate her, as if she needed any motivation. As she licked the last girl,";
                        ss << " she suddenly gasped as he shoved her face in the girl's pussy and pushed himself into hers. As ${name} was being fucked, she crawled on top of the virgin";
                        ss << " teen and pressed her tits into the other girl's, nipples roughly rubbing together as she ground their clits together. ${name} came three";
                        ...
                        ss << " The gang member slapped ${name}'s ass once, and she began to gingerly lick the jizz from the teen's nipples.";
                        training += 2;
                    }
                else
                    {
                        ss << "You clip a leash to ${name}'s collar and she barks happily. She knows she's just your pet bitch, and she's happy to be with her master.\n";
                        /**/
                        ss << "You take great care of your pets, taking them to the vet as often as you can. It's ${name}'s turn to visit the veterinarian, and you'll be taking time out to bring her yourself.";
                        ...
                        ss << " First ${name} gets a treat with her breakfast, and soon after you're both off down the road to the vet, by way of the park.";
                        ss << " In the park you stop and let ${name} off her leash.";
                        ...
                        /**/
                        ss << "When she's tired herself out, ${name} crawls back over to you and curls up between your legs, resting her head for a few minutes.";
                        ...
                        ss << " It's clear ${name} likes they new girl but is also afraid, perhaps because the girl's owner has given her limbs some amputations in order to make her a smaller breed.";
                        ss << " ${name} clearly had mixed feelings when led her back to the room for her checkup.";
                        /**/
                        ...
                        ss << " He also drew a vial of blood, all the while telling ${name} what a good girl she was.";
                        ss << " Half an hour later the nurse informed you of ${name}'s clean bill of health, stroking her hair and letting your trembling pet what a good girl she was, letting her nibble a treat from her palm.";
                        ...
                        ss << " ${name} clearly enjoyed that part of the process, but was relieved to have it over and be heading home with her Master.";
                        training += 2;
                    }
            }
        else if (girl.get_training(TRAINING_PUPPY) >= 50)
            {
                ...
                else if (roll_b >= 85 && brothel->num_girls_on_job(JOB_HEADGIRL, false) >= 1 && !girl.has_active_trait(
                        "Your Daughter") &&
                         girl.has_active_trait("Kidnapped"))
                {
                    ss << headname << " clips a leash to ${name}'s collar. She is happy with her leash being held and content that she's a pet.\n";
                    /**/
                    ss << "${name} had mixed feelings about her occasional walks with " << headname << " or her Master, or even more occasionally her Master's recruiter.";
                    ...
                    ss << " A couple times, ${name} thought she'd seen family or a friend in the distance, but never up close. Today was not to be her day.\n";
                    /**/
                    ...
                    ss << " ${name} recognized the man almost immediately as her father, and almost said so,";
                    ...
                    ss << " He had clearly been preoccupied before, and almost ran into them. \"So sorry. What a cute d-\" ${name}'s father froze, halfway bent to pet his";
                    ss << " daughter, naked at the end of this woman's leash. \"...sweetie?\" ${name}'s eyes brimmed with tears as she looked back and forth between her father and " << headname << ".";
                    ss << " She knew she'd be punished severely for speaking. With resignation, ${name} barked, and began licking her father's outstretched fingers.";
                    ss << " \"Yes?\" " << headname << " said expectantly, not really sure what was going on, but certain it was ~gold~ for ${name}'s training.\n";
                    /**/
                    ...
                    ss << " ${name}, be a good girl, show him what you want!\" ${name} whimpered, but slowly brought herself to her father's crotch, and began licking";
                    ...
                    ss << " \"Is there perhaps something she could... do for you?\" " << headname << " whispered in the man's ear coyly, stroking ${name}'s hair with one hand,";
                    ...
                    ss << " " << headname << " said in an innocent tone, tugging ${name}'s leash to propel the humiliated girl down the path again, face now sticky She never once spoke.";
                }
                else if (roll_b >= 70 && brothel->num_girls_on_job(JOB_RECRUITER, false) >= 1)
                {
                    ss << recruitername << " clips a leash to ${name}'s collar. She is happy with her leash being held and content that she's a pet.\n";
                    /**/
                    ...
                    ss << " One dirty old man politely knelt down, petting ${name}'s hair, and asked with a smile if she would like a bone.";
                    ss << " Your pet barked happily, but the girl holding her leash tugged it gently, thanking the old man. ${name} was a little disappointed, but she knew better than to disobey while leashed.";
                    ...
                    ss << "${name} became aroused as she happily licked the girl's cunt, sucking her clit till she came. For being such a good pet, she's allowed to sleep at the foot of the girl's bed that night instead of in her kennel.";
                    training += 2;
                }
                else if (roll_b >= 55 && brothel->num_girls_on_job(JOB_PERSONALBEDWARMER, false) >= 1)
                {
                    ss << bedname << " clips a leash to ${name}'s collar. She is happy with her leash being held and content that she's a pet.\n";
                    /**/
                    ss << "\"Isn't she cute?\" " << bedname << " beamed, stroking ${name}'s soft hair. The other girls nodded in agreement, occasionally reaching out to pet her. \"It must have been touch to realize you're just a little bitch though, huh?\"";
                    ...
                    ss << " ${name} didn't mind the humilitating comment. It's true, she was just a bitch, and deserved to be treated as what she was. She didn't think " << bedname << " was so great though.";
                    ...
                    ss << " \"Master?! I- we- that is, I was just getting myself ready for you. I hope you don't mind, I do love your pet. ${name} is so affectionate.\"";
                    ...
                    ss << " ${name} yips and rubs her face against your bulge as you pull a hood tight over the bedwarmer's face and close the closet.\n";
                    /**/
                    ...
                    ss << " You smile and pat the side of your leg. With a happy bark, ${name} leaped up on the bed and draped herself over your leg.";
                ...
                else if (roll_b >= 35 && brothel->num_girls_on_job(JOB_CLEANHOUSE, false) >= 1)
                {
                    ss << cleanername << " clips a leash to ${name}'s collar. She is happy with her leash being held and content that she's a pet.\n";
                    /**/
                    ss << "It was time for ${name}'s daily bath, something she and RandomHouseCleaner always enjoyed.";
                    ...
                    ss << " When she was finished, ${name} was dried off with a towel, and a leash clipped to her collar.";
                    ss << " \"I'm afraid the Master is out today, sweetie, and the other girls have more chores than normal.";
                    ss << " It'll just be you and me.\" She could tell ${name} was disappointed, but she crawled along after her anyway.\n";
                    /**/
                    ss << "" << cleanername << " cleaned the rooms, scrubbing the floor and dusting, gathering the girls' laundry for washing.";
                    ss << " ${name} did her best to behave, but still rolled around and looked for mischief,";
                    ...
                    ss << " ${name} was so good that " << cleanername << " decided to give her a treat, and let her play one of her favorite games:";
                    ss << " Fetch the Dildo! ${name} barked happily and would chase the dildo down, scooping it up in her mouth and bringing it back.";
                    ss << " When it was back, she would growl and suck it in greedily, tugging on it back and forth.\n";
                    /**/
                    ss << "When ${name} was worn out, both of them collapse on the ground. " << cleanername << " stroked ${name}'s hair as the girl nuzzled and kissed her legs, licking as she went.";
                    ...
                    ss << " " << cleanername << " pushed the dildo back and forth, causing ${name} to grind backwards, wanting the dildo deeper and faster.";
                    ss << " As ${name} was about to cum, the dildo stopped, causing her to whine, pleading. \"Come on girl, you know your owner hasn't given you permission.\" ${name} knew she was right, but that didn't make it any easier.";
                    ss << " Absently, " << cleanername << " pulled the dildo from the girl's pussy and brought it to her mouth. Obediently, ${name} licked and sucked the dildo clean, and then licked her juices from the girl's fingers.";
                ...
                else if (roll_b >= 15)
                {
                    ...
                    ss << " When she sees her bone, ${name} gives a happy yip and begins to lick your prick up and down, her pretty eyes peering at you from under your desk.";
                ...
                else
                {
                    ss << "You clip a leash to ${name}'s collar and she barks happily. She knows she's just your pet bitch, and she's happy to be with her master.\n";
                    /**/
                    ss << "\"Ah, damn, I forgot something.\" You curse, and loosely tie the leash to ${name}'s collar to a tree outside the shop on the edge of town.";
                    ss << " \"Stay, girl.\" ${name} whined as her Master pet her hair a moment,";
                    ...
                    ss << " and smell. ${name} sniffed the air, enjoying the smell of the flowers, and listening to the birds chatter.";
                    ss << " A cart drove past, pulled by a few ponygirls, with a coffel of pretty slaves trotting blindly behind it,";
                    ss << " hooded. ${name} barked excitedly at the moaning girls passing, but once they passed, she curled up again. Master sure was taking a while.\n";
                    /**/
                    ss << "Suddenly ${name} noticed something. Her leash, which you had tied so hastily to the small tree, was slack. Indeed, it was laying on the ground, having come undone! ${name} froze, frightened for some reason,";
                    ...
                    ss << " while ${name} became more and more afraid and perturbed by them. She forced herself to crawl to the edge of the grass,";
                    ...
                    /**/
                    ss << "Abruptly the door open. Master was back! \"Hey girl, sorry about that. Did you miss me?\" ${name} barked loudly and began to whine, crawling";
                    ...
                    ss << " you, cowering. You pick up the end of her leash and pet her hair, tits and chest until ${name} stopped trembling.";
                    ss << " Standing up, the tension was back on the leash, and the bad thoughts were gone. ${name} was where she was supposed to be.";
                    ss << " \"C'mon girl, let's go home. You deserve a treat, and I think " << headname << " got you some more Bitch Bites.\" ${name} barked happily.";
                    training += 2;
                }
            }
        else/*LOW SKILL*/
            {
                ...
                if (roll_b >= 66)
                {
                    ss << "${name} patiently waited in her kennel, still uneasy at being kept in the small cage. She was having a difficult time adjusting to her new life. New life? She guessed it was.";
                    ...
                    ss << "${name} shuddered, realizing that she was having a hard time thinking of herself as such. She was afraid of losing herself, of becoming what she was- no, what she was being trained to be.\n";
                    /**/
                    ss << "But even so, there was a dark pleasure she had noticed forming in her, and that scared her most of all, even more than her Master and the girls that he let hold her leash as they walked upright. Leash. ${name} shuddered again.";
                    ...
                    ss << " Then why, when she heard it jingle, did she feel such anticipation, and joy? Was she beginning to associate her humiliation with these things? ${name} supposed she was. Jingle. Tingle. Jingle. Tingle.\n";
                    /**/
                    ss << "${name} looked up as she got up on all fours, her pussy suddenly aching, her nipples stiffening. Master was here. How she hated him.... and loved him. She was so confused, all the time.";
                    ss << " The leash was the only thing that made sense. Jingle. Tingle.";
                    ss << " Master undid the lock on her kennel, and ${name}'s ass began to wag unconsciously. She licked Master's hand affectionately, begrudgingly.";
                    ...
                    ss << " Ever so slowly, his hand rose to meet her collar, leash in hand. An overly loud click. ${name} shuddered, her eyes momentarily closed. \"Heel.\"";
                    training += 2;
                }
                else if (roll_b >= 33 && brothel->num_girls_on_job(JOB_HEADGIRL, false) >= 1)/*NEEDS MOVED TO MID LVL*/
                {
                    ss << headname << " clips a leash to ${name}'s collar. She is happy with her leash being held and content that she's a pet.\n";
                    /**/
                    ss << headname << " lead ${name} into the kitchen, crawling with decent posture to her food bowl. ${name} was a little confused, as Master was";
                    ...
                    ss << " \"Good girl,\" " << headname << " cooed, kneeling beside ${name} and stroking her hair.";
                    ss << " \"Eat up!\" ${name} lowered her head to her morning kibble, and felt " << headname << " gently tug her hair before she could begin.";
                    ss << " \"Wait, girl, just a moment. You're doing so well, but it's time we work on your posture.\"";
                    ss << " ${name} looked up at the woman that was now stroking her hair and gently licked " << headname << "'s fingers.\n";
                    /**/
                    ss << "�A good puppy must have the right submissive posture at all times, even while eating.� " << headname << " explained.";
                    ss << " She pressed ${name}'s body with her hands, showing her the proper form.";
                    ss << " Soon ${name} had her tits pressed to the ground, just in front of her knees which were curled up beneath her.";
                    ss << " " << headname << " then showed her how her paws, forearms, and elbows were to remain pressed to the ground at all times.";
                    ss << " It took a few minutes, but soon ${name} was able to hold the awkward posture, against the will of her screaming muscles.";
                    ss << " \"Good girl,\" " << headname << " cooed again, petting ${name}'s hair and back. \"Now, try to keep position.\"\n";
                    /**/
                    ...
                    ss << " The posture itself gave a pleasing bouncy affect. " << headname << " stroked her back and occasionally patted ${name}'s";
                    ss << " ass comfortingly, pressing her fingers between her legs. Eating was a bit slower than normal,";
                    ss << " though ${name} tried to eat faster because the posture felt painful. Finally finished, she licked her bowl, took a few laps of";
                    ss << " water, and arched her back up, pressing her cheek against " << headname << "'s breasts, hidden in her tight blouse.";
                    ss << " \"Good girl, ${name}.\" " << headname << " was quite pleased, petting the girl's head.";
                    ss << " \"You'll get used to it with practice. Just keep at it, we wouldn't want to need to punish you, would we?\"";
                    ss << " ${name} barked, and a leash was attached to her collar. Her day was just beginning.";
                    training += 2;
                }
                else
                {
                    if (girl.oralsex() < 35)
                    {
                        ss << "You clip a leash to ${name}'s collar and she barks uneasily. She knows she's just your pet bitch, but she remembers when she wasn't. She hasn't quite embraced this life yet.\n";
                        /**/
                        ss << headname << " happened by as you spent an afternoon  working out a new business strategy, ${name} keeping herself entertained with your cock beneath your large, glass desk.";
                        ss << " \"Problem sir?\" You sighed, clearly unhappy. \"Not really, " << headname << ".\" You reply, rubbing your temples.";
                        ss << " \"${name} is coming along nicely, but her skills at sucking cock are... lackluster at best. It's not that she's not making an effort,";
                        ss << " the basics just haven't clicked yet is all.\" " << headname << " smiled knowingly, watching through the glass as ${name} bobbed up and down with difficulty.";
                        ss << " \"I'm sure with more training she will learn to apply herself, sir. I've got just the thing that will fix this.\"\n";
                        /**/
                        ss << "When ${name} crawled into the dining room for dinner, she was surprised to find only her bowl of kibble, no water bowl. \"Here girl!\" " << headname << " called from the";
                        ss << " kitchen, \"I've got something for you!\" ${name} crawled across the wooden floors past her master and the other girls and";
                        ss << " real people who were sitting down to eat. " << headname << " was standing by the sink where ${name} was greeted by a peculiar development.";
                        ...
                        ss << " Tears welled up in ${name}'s eyes but " << headname << " patted her asscheeks and cooed softly in her ear, \"Shhhh, good girl,";
                        ss << " you'll learn. It's not so bad, you'll learn to love it.\" Then " << headname << " left ${name} alone with the flaccid dick hanging on the wall.\n";
                        /**/
                        ss << "${name} gingerly put her lips around the cock. She was quite surprised to find it was warm to the touch, and pulsed gently, just like a human cock.";
                        ss << " It took nearly ten frustrating minutes for her to realize she had to tease it with her tongue to bring the water";
                        ss << " cock to an erect position. Once ${name} finally finished running her tongue up and down the large member, tickling it's head, she finally began to suck.";
                        ...
                        ss << " continuing to tease the cock. ${name} still had great difficulty getting the cock even a little bit into her throat, though it seemed a little";
                        ss << " easier as time went on. Suddenly the cock spurted cool, crisp water down her throat, and ${name} moaned. She had never imagined water could";
                    ...
                    {
                        ss << "${name} slurped heavily on her Master's cock, her head carefully bobbing so as not to graze the table. That skill had taken practice, but practice was something she got quite a bit of, these days.";
                        ...
                        ss << "${name} kept her eyes up as she sucked, even though he didn't look down, as was proper etiquette. She hated to admit it, but she was eager for Master's cum.";
                        ss << " She was always eager for Master's cum. Her meals were just bland and not filling. ${name} blinked, stopping for a moment. Did she really just think that? That horrible dog food? Was she already forgetting being a person?";
                        ss << " Master's hand brought her out of her revere, and she quickly resumed sucking his pulsing cock as he pet her hair. ${name} marveled at the fact that his petting actually felt good, in so many ways. Why?";
                        ...
                        /**/
                        ss << "Something jolted ${name} out of her trance. Master said her name. She wasn't looking up, she realized. ${name} flicked her eyes upwards and began sucking and licking Master's waning cock again. He was smiling. \"Yes, you ~are~ a good girl. You definitely deserve this gift.\"";
                        ss << " Gift? What was Master saying? What gift? ${name} looked on longingly as he put away his cock, and clipped a leash to her collar. Where were they going? It didn't matter, ${name} admonished herself. He held the leash.\n";
                        /**/
                        ss << "The bedroom, it turned out. Two of Master's bedwarmers lay wrapped in an embrace in his bed. Did she get to sleep at the foot of the bed? Was that her gift for being a good girl? ${name} longed to play with Master and his bedwarmers, but he didn't lead her to the bed.";
                        ...
                        ss << " Only it was a different doggie bed. It took ${name} a few moments to get over her shock. HER CLOTHES. The clothes she was kidnapped in!";
                        ...
                        ss << " \"Well, go on!\" ${name} jolted back to reality with a gentle slap on her ass, realizing the leash had been unclipped. She crawled obediently to the bed, first sniffing and nuzzling it, then doing a couple turns as she crawled on top of it's fluff.";
...
double JP_HousePet(const sGirl& girl, bool estimate)// not used
{
    return 0;
}
