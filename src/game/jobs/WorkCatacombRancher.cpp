...
// `J` Job Farm - Laborers
bool WorkCatacombRancher(sGirl& girl, bool Day0Night1, cRng& rng)
{
...
#pragma region //    Job Performance            //
    ...
    double jobperformance = girl.job_performance(JOB_CATACOMBRANCHER, false);
...
double JP_CatacombRancher(const sGirl& girl, bool estimate)// not used
{
