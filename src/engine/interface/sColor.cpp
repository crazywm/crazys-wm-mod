...
std::uint8_t sColor::convertFromHex(std::string hex)
{
    std::uint8_t value = 0;
...
void sColor::HexToSDLColor(std::string HexColor, SDL_Color* SDLColor)
{
...
void sColor::RGBToSDLColor(SDL_Color* SDLColor, int r = 0, int g = 0, int b = 0)
{
    SDLColor->r = r;
    SDLColor->g = g;
    SDLColor->b = b;
