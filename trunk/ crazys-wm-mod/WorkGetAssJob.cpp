...
bool cJobManager::WorkGetAssJob(sGirl* girl, sBrothel* brothel, int Day0Night1, string& summary)
{
	string message = "";
	...
	{
		message = girl->m_Realname + gettext(" already has a Great Arse so she was sent to the waiting room.");
