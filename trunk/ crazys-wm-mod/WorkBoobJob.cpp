...
bool cJobManager::WorkBoobJob(sGirl* girl, sBrothel* brothel, int Day0Night1, string& summary)
{
	string message = "";
	...
	{
		message = girl->m_Realname + gettext(" already has Abnormally Large Boobs so she was sent to the waiting room.");
