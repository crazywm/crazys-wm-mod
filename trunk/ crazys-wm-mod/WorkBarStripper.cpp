...
bool cJobManager::WorkBarStripper(sGirl* girl, sBrothel* brothel, int DayNight, string& summary)
{
	...
	//gained
	g_Girls.PossiblyGainNewTrait(girl, "Sexy Air", 70, ACTION_WORKSTRIP, girlName + " has been stripping and having to be sexy for so long she now reeks of sexyness.", DayNight != 0);

	//lose
	g_Girls.PossiblyLoseExistingTrait(girl, "Nervous", 20, ACTION_WORKSTRIP, girlName + " has had so many people see her naked she is no longer nervous about anything.", DayNight != 0);
