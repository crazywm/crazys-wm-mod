...
bool cJobManager::WorkHallEntertainer(sGirl* girl, sBrothel* brothel, bool Day0Night1, string& summary)
{
	...
	ss << "She worked as an entertainer in the gambling hall.";
	...
	if (g_Dice.percent(50))
	{
		...
		{
			ss << " " + girlName + "'s cheeriness improved her performance. ";
			jobperformance += 5;
		}
		if (g_Dice.percent(10))
		{
			...
			{
				ss << " A born stripper, " + girlName + " wears her clothes just short of showing flesh. The customers like this. ";
				jobperformance += 15;
			}
