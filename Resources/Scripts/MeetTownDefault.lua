...
function BouncerShakedown(girl, dangerLev)
    ...
    elseif shakedown == 2 then
        ...
        local stripper1 = wm.CreateRandomGirl(wm.Range(18,30), false, false, false, false)
        local stripper2 = wm.CreateRandomGirl(wm.Range(18,30), false, false, false, false)
        local stripper3 = wm.CreateRandomGirl(wm.Range(18,30), false, false, false, false)
        local stripper4 = wm.CreateRandomGirl(wm.Range(18,30), false, false, false, false)
