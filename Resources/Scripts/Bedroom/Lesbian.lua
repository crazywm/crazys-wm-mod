...
function HandleLesBDSM(girl, other_name)
    if (girl:skill_check(wm.SKILLS.LESBIAN, 25) and girl:skill_check(wm.SKILLS.BDSM, 40)) then
        ...
        if girl:bdsm() > 60 then
            suggest = ", with ${firstname} occasionally making suggestions for her bondage."
        end
        ...
        if girl:libido() > 85 then
            ...
            if girl:has_trait(wm.TRAITS.MASOCHIST) and wm.Percent(50) then
                ...
                Dialog("Being such a pain slut, this is enough to make ${firstname} cum. " .. other_name ..
                        ...
                        "She intensifies her spanking, the loud smacks now echoing through the room. ${firstname}'s ass turns bright red, then some bruises " ..
                        "start to appear.")
                local step_in = ChoiceBox("Step in?",  "${firstname} has had enough", "Let " .. other_name .. " proceed")
                girl:health(-1)
                if step_in then
                    ...
                    Dialog("\"You came without my permission\", " .. other_name .. " chides ${firstname} \"As a punishment, I'm making sure "  ..
                ...
                Dialog("This continuous on for several minutes, until ${firstname}'s rear has turned bright red." ..
                ...
                if choice == 0 then
                    ...
                    Dialog("Dutifully, " .. other_name .. " starts working on ${firstname} with her fingers. She is so horny, it doesn't even take her a " ..
                        "minute to get her to climax for the first time. ")
                    SheJustCame(girl, 10)
                    wm.UpdateImage(wm.IMG.LICK, ImageOptions.LESBIAN + ImageOptions.TIED_UP)
                    Dialog("After the second orgasm, " .. other_name .. " switches to licking ${firstname}'s pussy. As her next orgasm builds, " ..
                    ...
                    if girl:has_trait(wm.TRAITS.NYMPHOMANIAC) and girl:tiredness() < 70 then
                        ...
                        Dialog(other_name .. " manages to coax two more orgasms out of ${firstname}, but it appears that she is completely spent now." ..
                ...
                elseif choice == 1 then
                    Dialog("\"I don't think ${firstname} was giving her all today. Maybe we should motivate her a bit more\". ")
                    wm.UpdateImage(wm.IMG.CHASTITY, ImageOptions.LESBIAN)
                ...
                elseif choice == 2 then
                    ...
                    Dialog("\"You did well\", you tell ${firstname}. \"So here's your reward!\"\n" ..
        ...
        elseif girl:libido() > 33 then
            ...
            Dialog("Soon, ${firstname}'s wrists and feet are cuffed and secured to the four corners of her bed. " ..
            ...
            Dialog(other_name .. " fetches a flogger. \"Let's see if we can make your squirm.\"\n" ..
                    "She proceeds to flog ${firstname}'s stomach, chest, and inner thighs. " ..
            ...
            if what == 0 then
                ...
                Dialog("\"".. other_name ..", I think this is about as much as ${firstname} can take\"." ..
                ...
                if girl:libido() > 66 and wm.Percent(50) then
                    ...
                    Dialog("After some vigorous finger-fucking, and with the help of her tongue, " .. other_name ..
                            "manages to bring ${firstname} to orgasm.")
                    SheJustCame(girl, 3)
                end
                wm.UpdateImage(wm.IMG.BED, ImageOptions.LESBIAN + ImageOptions.TIED_UP)
            ...
            elseif what == 1 then
                ...
                if girl:constitution() < 40 or girl:health() < 40 then
                    wm.SetPlayerDisposition(-1)
                    girl:pcfear(1)
                    Dialog("By the time " .. other_name .. " is done with her flogging, tears are streaming down ${firstname}'s face." ..
                                 "\"Oh you poor thing, was that too much for you?\" " .. other_name .. " mocks. \"Then let us switch things up a bit!\"")
                else
                    Dialog(other_name .. " continues flogging ${firstname} for another minute or so. " ..
                ...
                if gag == 1 then
                    ...
                    if girl:has_trait(wm.TRAITS.STRONG_GAG_REFLEX) or (wm.Percent(50) and girl:has_trait(wm.TRAITS.GAG_REFLEX) ) then
                        ...
                        Dialog("You find it difficult to get in the mood again after this shock, and soon decide to go, leaving " ..
                                other_name .. " in charge or making sure ${firstname} is alright.")
                    else
                        Dialog("Now, whenever " .. other_name .. " is about to strike, you pinch ${firstname}" ..
        ...
        girl:tiredness(4)
        wm.UpdateImage(wm.IMG.SUB, ImageOptions.LESBIAN)
        Dialog(other_name .. " starts to tie up ${firstname}. From her panicked expression it becomes apparent that "
                .. "${firstname} lacks the necessary experience for this.")
        if wm.GetPlayerDisposition() > -33 then
            Dialog("\"OK, " .. other_name .. ", I think that's enough for now. Poor ${firstname} is already shaking.\"\n" ..
            "Then you add: \"Maybe there is another way you can get her to shake.\"")
            wm.UpdateImage(wm.IMG.LICK, ImageOptions.LESBIAN)
            Dialog("The ropes undone, ${firstname} lies down on your bed and " .. other_name .. " buries her head in her crotch. ")
            Dialog("After the first orgasm shudders through her body, you tell " .. other_name .. " to intensify her efforts, while you " ..
            "start binding ${firstname} in a spread-eagle position, fixing her hands and feet to the bedposts.")
            ...
            if girl:libido() > 33 then
                ...
                if girl:libido() > 66 then
                    ...
                    "Even though you really wanted to see ${firstname} in bondage, you suppose " ..
                ...
                Dialog("They switch places, with ${firstname} now licking " .. other_name .. "'s pussy.")
                if girl:skill_check(wm.SKILLS.LESBIAN, 33) then
                    ...
                    Dialog("It soon becomes apparent, though, that ${firstname} isn't really up to that task either. " ..
                    "With an apology for ${firstname}'s lack of skill, you send " .. other_name .. " on her way, excited but unsatisfied. " ..
...
function BdsmFaceSitting(girl, other_name)
    ...
    Dialog("With that, " .. other_name .. " lowers herself on ${firstname}'s face. " ..
            "${firstname}'s tongue eagerly starts licking the offered pussy. Soon, " .. other_name ..
            " is moaning loudly. She presses her hips further into ${firstname}'s face, cutting off her air supply at times.")
    Dialog("When " .. other_name .. " finally cums and lifts herself up a bit, ${firstname}'s face is dark red, " ..
    ...
    if girl:skill_check(wm.SKILLS.LESBIAN, 75) then
        ...
        elseif position == 1 then
            ...
            if girl:beauty() > 35 then
                ...
                beauty_text = "Unfortunately, ${firstname} isn't really that impressive to look at, and you resort to closing your eyes and focus on her moans, which do get you excited. "
            end
        ...
        elseif position == 2 then
            wm.UpdateImage(wm.IMG.EATOUT)
            Dialog(other_name .. " lies down on her back, and ${firstname}" ..
