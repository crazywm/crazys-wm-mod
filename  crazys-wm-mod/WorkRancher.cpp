...
// `J` Farm Job - Laborers
bool cJobManager::WorkRancher(sGirl* girl, sBrothel* brothel, int Day0Night1, string& summary)
{
	string message = "";
	...
	int wages = 25;
	message += "She worked as a rancher on the farm.";

	int roll = g_Dice%100;
	int jobperformance = (	g_Girls.GetSkill(girl, SKILL_BEASTIALITY)/2 + 
	...
	girl->m_Events.AddMessage(message, IMGTYPE_HERD, Day0Night1);
