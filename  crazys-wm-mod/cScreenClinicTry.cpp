...
bool cScreenClinicTry::ids_set = false;

void cScreenClinicTry::set_ids()
{
	ids_set			/**/ = true;
	g_LogFile.write("set_ids in cScreenClinicTry");
...
string cScreenClinicTry::walk_no_luck()
{
	if(m_first_walk) {
		m_first_walk = false;
