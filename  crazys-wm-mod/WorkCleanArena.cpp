...
bool cJobManager::WorkCleanArena(sGirl* girl, sBrothel* brothel, int Day0Night1, string& summary)
{
	string message = "";
	...
	ss << girlName << " worked cleaning the arena.\n\n";

	if (roll_a <= 50 && g_Girls.DisobeyCheck(girl, ACTION_WORKCLEANING, brothel))
	{
		ss << "She refused to clean the arena.";
