...
bool cJobManager::WorkGetVaginalRejuvination(sGirl* girl, sBrothel* brothel, int DayNight, string& summary)
{
	string message = "";
	u_int job = 0;	
	...
	//half ass fix to make sure it doesn't keep doing the surgery once she is a virgin
	if (girl->m_Virgin)
	{
