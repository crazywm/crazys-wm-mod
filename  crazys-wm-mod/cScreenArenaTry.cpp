...
bool cScreenArenaTry::ids_set = false;

void cScreenArenaTry::set_ids()
{
	ids_set			/**/ = true;
	g_LogFile.write("set_ids in cScreenArenaTry");
...
string cScreenArenaTry::walk_no_luck()
{
	if (m_first_walk) {
		m_first_walk = false;
