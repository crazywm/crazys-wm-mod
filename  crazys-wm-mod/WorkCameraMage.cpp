...
bool cJobManager::WorkCameraMage(sGirl* girl, sBrothel* brothel, int Day0Night1, string& summary)
{
	...
	{
		ss << girlName << " worked as a cameramage.\n\n";
	}
	else
	{
	...
	/* */if (jobperformance > 0)	ss << "She helped improve the scene " << jobperformance << "% with her camera skills. \n";
