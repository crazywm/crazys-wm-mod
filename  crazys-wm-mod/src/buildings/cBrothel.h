...
struct sBrothel : public IBuilding
{
    ...
    void save_additional_xml(TiXmlElement& root) const override;
    virtual bool LoadXML(TiXmlHandle hBrothel);
...
public:
    ...
    TiXmlElement* LoadBuildingsXML(TiXmlElement& root, const char * element_name, const char * manager_name = nullptr);
    TiXmlElement* SaveXML(TiXmlElement& root) const;
