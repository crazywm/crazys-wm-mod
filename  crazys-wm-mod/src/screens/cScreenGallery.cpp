...
cScreenGallery::cScreenGallery() : cInterfaceWindowXML("gallery_screen.xml")
{
}
...
void cScreenGallery::init(bool back)
{
	...
	if (usefolder == 0)
	{
	    throw std::runtime_error("ERROR: " + m_SelectedGirl->m_Realname + " ( " + m_SelectedGirl->m_Name + " ) has no images.");
	}
