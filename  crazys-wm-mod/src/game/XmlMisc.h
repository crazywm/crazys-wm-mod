...
bool LoadStatsXML(tinyxml2::XMLElement * pStats, int * stats, int * statMods = nullptr, int * tempStats = nullptr);
bool LoadSkillsXML(tinyxml2::XMLElement * pSkills, int * skills, int * skillMods = nullptr, int * tempSkills = nullptr);
