...
bool LoadStatsXML(tinyxml2::XMLElement* pStats, int * stats, int * statMods, int * tempStats)
{
...
bool LoadSkillsXML(tinyxml2::XMLElement* pSkills, int * skills, int * skillMods, int * tempSkills)
{
