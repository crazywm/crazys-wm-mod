...
bool cJobManager::WorkBarWhore(sGirl* girl, bool Day0Night1, string& summary)
{
	...
	*/
	...
	for (int i = 0; i < LoopCount; i++)	// Go through all customers
	{
		...
		else if (!brothel->is_sex_type_allowed(Cust.m_SexPref)) // it their first sexpref is banned then switch to the second
		{
