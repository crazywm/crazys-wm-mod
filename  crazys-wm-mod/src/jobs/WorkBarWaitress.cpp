...
// `J` Job Brothel - Bar
bool cJobManager::WorkBarWaitress(sGirl* girl, bool Day0Night1, string& summary, cRng& rng)
{
...
#pragma region //	Job Performance			//
	...
	if (girl->has_trait( "Mind Fucked") && rng.percent(20))
	{
	...
	if (girl->has_trait( "Massive Melons") || girl->has_trait( "Abnormally Large Boobs") || girl->has_trait( "Sexy Air")
				...
				|| girl->has_trait( "Busty Boobs") || girl->has_trait( "Giant Juggs") && rng.percent(20))
	{
	...
	if (girl->has_trait( "Shy") || girl->has_trait( "Nervous") && rng.percent(20))
	{
...
#pragma region	//	Finish the shift			//
	...
	{
		cGirls::PossiblyGainNewTrait(girl, "Fleet of Foot", 60, actiontype, girlName + " has been dodging between tables and avoiding running into customers for so long she has become Fleet of Foot.", Day0Night1);
	}

	//lose traits
	cGirls::PossiblyLoseExistingTrait(girl, "Clumsy", 30, actiontype, "It took her breaking hundreds of dishes, and just as many reprimands, but " + girlName + " has finally stopped being so Clumsy.", Day0Night1);
