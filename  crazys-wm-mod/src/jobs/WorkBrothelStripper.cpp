...
#pragma region	//	Finish the shift			//
	...
	//lose
	cGirls::PossiblyLoseExistingTrait(girl, "Nervous", 30, actiontype, girlName + " has had so many people see her naked she is no longer nervous about anything.", Day0Night1);
