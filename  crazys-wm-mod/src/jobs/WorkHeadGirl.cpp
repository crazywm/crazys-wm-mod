...
bool cJobManager::WorkHeadGirl(sGirl* girl, bool Day0Night1, string& summary, cRng& rng)
{
	...
	cGirls::PossiblyGainNewTrait(girl, "Psychic", 60, actiontype, "She has learned to handle the girls so well that you'd almost think she was Psychic.", Day0Night1);
