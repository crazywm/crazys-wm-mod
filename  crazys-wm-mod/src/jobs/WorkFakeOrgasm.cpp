...
bool cJobManager::WorkFakeOrgasm(sGirl* girl, bool Day0Night1, string& summary)
{
...
#pragma region //	Job setup				//
	...
	*/
	...
	if (!brothel->is_sex_type_allowed(SKILL_BDSM))			girl->m_WorkingDay -= g_Dice % 3;
	...
	if (!brothel->is_sex_type_allowed(SKILL_NORMALSEX))		girl->m_WorkingDay -= g_Dice % 10 + 5;
