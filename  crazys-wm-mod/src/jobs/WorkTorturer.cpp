...
bool cJobManager::WorkTorturer(sGirl* girl, bool Day0Night1, string& summary)
{
	...
	cGirls::PossiblyGainNewTrait(girl, "Merciless", 50, actiontype, girl->m_Realname + (" extensive experience with torture has made her absolutely Merciless."), Day0Night1);
