...
bool cJobManager::WorkBarStripper(sGirl* girl, bool Day0Night1, string& summary, cRng& rng)
{
...
#pragma region	//	Finish the shift			//
	...
	//gained
	cGirls::PossiblyGainNewTrait(girl, "Sexy Air", 80, actiontype, girlName + " has been stripping and having to be sexy for so long she now reeks of sexyness.", Day0Night1);
	...
	//lose
	cGirls::PossiblyLoseExistingTrait(girl, "Nervous", 20, actiontype, girlName + " has had so many people see her naked she is no longer nervous about anything.", Day0Night1);
	if (jobperformance > 150 && girl->confidence() > 65)
	{
		cGirls::PossiblyLoseExistingTrait(girl, "Shy", 60, actiontype, girlName + " has been stripping for so long now that her confidence is super high and she is no longer Shy.", Day0Night1);
	}
