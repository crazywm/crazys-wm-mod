...
break;	// end Es_DeadBeat
	...
	//gain traits
	cGirls::PossiblyGainNewTrait(girl, "Charismatic", 60, actiontype, "Dealing with customers and talking with them about their problems has made " + girlName + " more Charismatic.", Day0Night1);
	cGirls::PossiblyGainNewTrait(girl, "Elegant", 40, actiontype, "Playing the doting girlfriend has given " + girlName + " an Elegant nature.", Day0Night1);

	//lose traits
	cGirls::PossiblyLoseExistingTrait(girl, "Nervous", 40, actiontype, girlName + " seems to finally be getting over her shyness. She's not always so Nervous anymore.", Day0Night1);
	cGirls::PossiblyLoseExistingTrait(girl, "Aggressive", 70, actiontype, "Controlling her temper has greatly reduced " + girlName + "'s Aggressive tendencies.", Day0Night1);
