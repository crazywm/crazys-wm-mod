...
// `J` Job Clinic - Staff
bool cJobManager::WorkNurse(sGirl* girl, bool Day0Night1, string& summary, cRng& rng)
{
...
#pragma region //	Job Performance			//
	...
	if (girl->has_trait( "Clumsy") && rng.percent(20))
	{
		wages -= 15;
	...
	if (girl->has_trait( "Optimist") && rng.percent(20))
	{
		if (jobperformance < 125)
		{
			wages -= 10;
	...
	if (rng.percent(30) && !girl->check_virginity() && !girl->has_trait( "Lesbian")
...
#pragma region	//	Finish the shift			//
	...
	*/
	...
	//gain traits
	cGirls::PossiblyGainNewTrait(girl, "Charismatic", 60, actiontype, "Dealing with patients and talking with them about their problems has made " + girlName + " more Charismatic.", Day0Night1);
	//lose traits
