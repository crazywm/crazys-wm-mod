...
#pragma region //	Job Performance			//
	...
	*/
	...
	//lose traits
	cGirls::PossiblyLoseExistingTrait(girl, "Fragile", 35, actiontype, girlName + " has had to heal from so many injuries you can't say she is fragile anymore.", Day0Night1);
