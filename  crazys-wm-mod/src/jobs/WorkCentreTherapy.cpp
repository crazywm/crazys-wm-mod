...
bool cJobManager::WorkCentreTherapy(sGirl* girl, bool Day0Night1, string& summary, cRng& rng)
{
...
#pragma region //	Job setup				//
	...
	if (rng.percent(10) && girl->disobey_check(actiontype, JOB_THERAPY))
	{
