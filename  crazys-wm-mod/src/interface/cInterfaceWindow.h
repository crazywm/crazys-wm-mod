...
public:
    ...
    void AddButton(std::string image, int& ID, int x, int y, int width, int height, bool transparency = false, bool scale = true);
	// END MOD
	...
	void Focused();
	void SetFocusTo(cUIWidget* widget);
	void TabFocus();
...
public:
	...
	void define_widget(TiXmlElement * base_el, widget_map_t& widgets);
	void place_widget(TiXmlElement * el, std::string suffix, const widget_map_t& widgets);
	void widget_text_item(TiXmlElement *el, sXmlWidgetPart& xw);
	void widget_button_item(TiXmlElement *el, sXmlWidgetPart& xw);
	void widget_editbox_item(TiXmlElement *el, sXmlWidgetPart& xw);
	void widget_listbox_item(TiXmlElement *el, sXmlWidgetPart& xw);
	void widget_checkbox_item(TiXmlElement *el, sXmlWidgetPart& xw);
	void widget_widget(TiXmlElement *el, sXmlWidgetPart& xw);
	void widget_image_item(TiXmlElement *el, sXmlWidgetPart& xw);
	void widget_slider_item(TiXmlElement *el, sXmlWidgetPart& xw);
