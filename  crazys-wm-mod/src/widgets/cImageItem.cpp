...
void cInterfaceWindow::PrepareImage(int id, sGirl* girl, int imagetype, bool rand, int ImageNum, bool gallery, string ImageName)
{
	...
	bool armor = girl->get_num_item_equiped(INVARMOR) >= 1;
	bool dress = girl->get_num_item_equiped( INVDRESS) >= 1;
	bool swim = girl->get_num_item_equiped( INVSWIMSUIT) >= 1;
	bool lingerie = girl->get_num_item_equiped( INVUNDERWEAR) >= 1;
