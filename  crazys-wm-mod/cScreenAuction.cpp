...
bool cScreenAuction::ids_set = false;

void cScreenAuction::set_ids()
{
	ids_set			/**/ = true;
	g_LogFile.write("set_ids in cScreenAuction");
...
void cScreenAuction::init()
{
	// buttons enable/disable
}

void cScreenAuction::process()
{
