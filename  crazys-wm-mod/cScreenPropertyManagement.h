...
private:
	...
	void load_brothel_ui_ids(const std::string& prefix, BrothelUiIDs& target);
	void init_building_ui(std::string title, const sBrothel& building, const BrothelUiIDs& ui);
	void check_building_ui_events(sBrothel& building, const BrothelUiIDs& ui);
public:
